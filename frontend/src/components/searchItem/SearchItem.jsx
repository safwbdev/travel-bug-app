...
const SearchItem = ({ item }) => {
    return (
        <div className={classes.searchItem}>
            <img
                src={item.photos.length > 0 ? item.photos[0] : "https://cf.bstatic.com/xdata/images/hotel/square240/647130478.webp?k=622d868070952901f87760d0ee8eafb7a3d69c251131d826489cfacc2c098be4&o="}
                alt=""
            ...
            <div className={classes.searchItemDesc}>
                ...
                <span className={classes.searchItemSubtitle}>{item.title}</span>
                <span className={classes.searchItemFeatures}>{parse(item.desc)}</span>
